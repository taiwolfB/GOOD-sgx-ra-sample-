...
OBJEXT = o
OPENSSL_CPPFLAGS = -I/opt/openssl/1.1.1l/include
OPENSSL_LDFLAGS = -L/opt/openssl/1.1.1l/lib
...
#	-I/opt/openssl/1.1.1l/include $(am__empty)
...
client_LDFLAGS = $(AM_LDFLAGS) -L/opt/openssl/1.1.1l/lib
...
sp_LDFLAGS = $(AM_LDFLAGS) -L/opt/openssl/1.1.1l/lib 
mrsigner_LDFLAGS = $(AM_LDFLAGS) -L/opt/openssl/1.1.1l/lib
